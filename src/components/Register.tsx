                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    <div>
                        <img
                            ...
                            alt="AllBallCall"
                        />
                        <h2 className="mt-6 text-3xl font-extrabold text-gray-900">Register and call your own shots.</h2>
                        <p className="mt-2 text-sm text-gray-600">
                            Or{' '}
                            {/* register */}
                            <Link to="/login" className="font-medium text-indigo-600 hover:text-indigo-500">Already in our lineup? Sign-in.</Link>
                        </p>
                    </div>
